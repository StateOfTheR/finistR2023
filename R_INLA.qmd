...
Nous remarquons que les intensités sont les plus fortes dans la végétation br{Primaire}, ce qui est logique. Ici, l'intensité représente le nombre d'habitats de gorilles par unité de surface. Attention donc à comment vous définisser les coordonnées de vos zones d'études.
