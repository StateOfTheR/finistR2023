...
Une solution basée sur la création de différentes branches et des commandes `git stash` et `git pop`a émergé au moment de la restitution orale et sera testé dans un futur proche.
