...
L'objectif de ce tuto est de présenter des conseils pour écrire une issue pour demander des améliorations ou soumettre des bugs dans un code déposé sur GitHub.
...
2.  Donner un exemple reproductible dans un format
