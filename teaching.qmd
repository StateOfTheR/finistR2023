...
{learnr} permet de créer de tutoriaux interactifs en s'appuyant sur shiny. Le tutoriel est construit à partir d'un fichier Rmarkdown et peut être soit executé en local via le bouton `run app` soit en déployant le fichier sur un serveur Shiny.
