...
Contrairement à `torch`, on n'a pas d'optimiseur défini clé dans JAX. La dérivée est néanmoins une fonction *comme les autres* et on peut donc écrire très simplement un algorithme simple de descente de gradient. 
